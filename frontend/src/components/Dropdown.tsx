...
type DropdownProps<I extends string> = {
    entries: readonly { id: I, label: string }[],
    selectedValueId: I,
    onSelected: (id: I) => void
}

export function Dropdown<I extends string>(props: DropdownProps<I>) {
    ...
    return <div className="dropdown">
        <div className="dropdown-header" onClick={() => setExpanded(s => !s)}>
            <p className="dropdown-selected-value">{props.entries.find(e => e.id == props.selectedValueId)?.label}</p>
            <DownArrow/>
        </div>
