...
public class ProductControllerTests {
    ...
    public void productInfoTest() throws Exception {
        mockMvc.perform(get("/api/product?id=0")).andDo(print())
    ...
    public void postProductCommentTest() throws Exception {
        ...
        var product = dataStore.getCollection(DataStoreConfig.products).data()
    ...
    public void deleteProductsTest() throws Exception {
        ...
        var a = dataStore.getCollection(DataStoreConfig.products).data().toArray();
